...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMsg('Verification email sent. Please verify your email before logging in.');
      setName('');
      setEmail('');
      setPassword('');
      setConfirmPassword('');
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-slate-50 text-slate-900">
        ...
        <div className="relative z-10 space-y-12 my-auto max-w-2xl">
          ...
          <div className="space-y-4 pt-6 border-t border-white/5">
            <div className="flex items-center gap-3 transition-all duration-200 hover:translate-x-1.5 hover:text-white cursor-default group">
              ...
              <span className="text-sm text-slate-300 group-hover:text-white transition-colors">Create an account to start your study path</span>
            </div>
            <div className="flex items-center gap-3 transition-all duration-200 hover:translate-x-1.5 hover:text-white cursor-default group">
              <CheckCircle className="h-5 w-5 text-indigo-400 shrink-0 group-hover:scale-110 transition-transform" />
              <span className="text-sm text-slate-300 group-hover:text-white transition-colors">Access thousands of courses and exercises</span>
            </div>
            <div className="flex items-center gap-3 transition-all duration-200 hover:translate-x-1.5 hover:text-white cursor-default group">
              <CheckCircle className="h-5 w-5 text-indigo-400 shrink-0 group-hover:scale-110 transition-transform" />
              <span className="text-sm text-slate-300 group-hover:text-white transition-colors">Connect with expert teachers and peers</span>
            </div>
          </div>
        </div>
      ...
      {/* Right side: Registration form (Compact sidebar width, letting the banner occupy maximum space) */}
