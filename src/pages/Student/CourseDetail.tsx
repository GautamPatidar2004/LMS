                  ...
                  {checkingEnrollment ? (
                    ...
                    <div className="space-y-2">
                      ...
                      <button
                        ...
                        className="w-full py-2.5 rounded-xl font-bold text-xs bg-blue-600 hover:bg-blue-700 text-white transition-all flex items-center justify-center gap-1.5 shadow-sm shadow-blue-600/10 hover:shadow-blue-600/20"
                      >
                        Get Started
                      </button>
                    </div>
